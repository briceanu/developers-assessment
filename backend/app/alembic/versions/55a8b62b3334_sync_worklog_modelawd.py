"""sync worklog modelawd

Revision ID: 55a8b62b3334
Revises: 5d52207edf51
Create Date: 2026-02-01 21:34:34.619400
...
revision: str = '55a8b62b3334'
down_revision: Union[str, Sequence[str], None] = '5d52207edf51'
...
def upgrade() -> None:
    ...
    op.create_table('worklog',
                    ...
                    sa.Column('created_at', sa.DateTime(), nullable=False),
                    sa.Column('updated_at', sa.DateTime(), nullable=False),
                    sa.Column('total_duration_minutes',
    ...
    op.create_index(op.f('ix_timesegment_user_id'),
                    'timesegment', ['user_id'], unique=False)
